<<html lang="pt-br">
                ...
                function exibirModal(estacionamento) {
                    ...
                    for (var i = 0; i < 12; i++) {
                        ...
                        for (var j = 0; j < 24; j++) {
                            ...
                            tabelaHTML += vaga.Tipo !== "Vazio" ? (vaga.Tipo == "Objeto" ?
                                '<div class="objeto" style="display: flex;justify-content: center;align-items: center;"></div>' :
                                (proximoElementoNaoVazio ? '<div class="vagacima ' + status + ' ' + lado +
                                    '" style="display: flex;justify-content: center;align-items: center;"> ' + icone +
                                    ' </div>' : '<div class="vaga ' + status + ' ' + lado + ' ' + ElementoAnteriorVazio +
                                    '" style="display: flex;justify-content: center;align-items: center;"> ' + icone +
                                    ' </div>')) : '<div class="vazio col"></div>';
                            tabelaHTML += '</div>';
                            tabelaHTML += '</td>';
                        }
                        tabelaHTML += '</tr>';
    ...
    <body class="pt-4">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content quadro">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn btn-link favorite-btn" data-dismiss="modal"
                            aria-label="Favoritar" name="favoritar">
        ...
        <script
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAtI-_4umSKFC-kkL4yNoUTRfBI-Qo0NDM&callback=initMap&v=weekly"
            defer></script>
